...
-- Problem 07                                 -- МИНУТА 1:17:00
   SELECT [o].[Name]
       AS [Owner],
          COUNT([a].[Id])                     -- COUNT(*) дава 26бр. но всички с null не ги показва с 0, а с 1, въпреки че не ги брои
       AS [CountOfAnimals]                    -- COUNT([a].[Id]) дава 26бр. но има 0 брой      
     FROM [Owners]
       AS [o]
LEFT JOIN [Animals]
       AS [a]
    ...
    RETURNS INT
       ...
       RETURN (
                    SELECT
                     ...
                     FROM [Volunteers]
                       AS [v]
                LEFT JOIN [VolunteersDepartment]
                       AS [vd]
                       ON [v].[DepartmentID] = [vd].[Id]
