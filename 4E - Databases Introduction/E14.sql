...
(
    ...
    DailyRate DECIMAL(6,1) NOT NULL,
    WeeklyRate DECIMAL(6,1) NOT NULL,
    MonthlyRate DECIMAL(6,1) NOT NULL,
    WeekendRate DECIMAL(6,1) NOT NULL
)
...
INSERT INTO Cars (PlateNumber, Manufacturer, Model, CarYear, CategoryId, Doors, Picture, Condition, IsAvailable) 
  VALUES
